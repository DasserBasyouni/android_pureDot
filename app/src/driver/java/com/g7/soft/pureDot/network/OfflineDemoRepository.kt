...
class OfflineDemoRepository {
    ...
    companion object {
        ...
        private val newDeliveryOrder1 = hashMapOf(
            "number" to 512,
            ...
            "status" to ApiConstant.OrderStatus.BEING_SHIPPED.value,
            "deliveryStatus" to ApiConstant.OrderDeliveryStatus.NEW.value,
            "shopName" to "shop x",
        ...
        private val newDeliveryOrder2 = hashMapOf(
            "number" to 664,
            "dateTime" to Calendar.getInstance().apply {
                this.set(Calendar.HOUR_OF_DAY, 0)
                this.set(Calendar.MINUTE, 0)
        ...
        private val service1 = hashMapOf(
            ...
            "name" to "service 1",
            "price" to 41.50,
            "items" to listOf(cartItemsModel1, cartItemsModel2),
        ...
        // Availability
        val checkAvailability: HashMap<String, Any?>
            get() = hashMapOf(
                "status" to ApiConstant.Status.SUCCESS.value,
                "data" to hashMapOf(
                    "isAvailable" to true,
                    "currentShift" to hashMapOf(
                        "id" to 1,
                        "fromTime" to Calendar.getInstance().apply {
                        ...
                        "toTime" to Calendar.getInstance().apply {
                            this.set(Calendar.HOUR_OF_DAY, 14)
                            this.set(Calendar.MINUTE, 0)
                            this.set(Calendar.SECOND, 0)
                            this.set(Calendar.MILLISECOND, 0)
                            this.set(Calendar.ZONE_OFFSET, 0)
        ...
        val getWorkingHours = hashMapOf<String, Any?>(
            "status" to ApiConstant.Status.SUCCESS.value,
            "data" to hashMapOf(
        ...
        val getItemDetails: HashMap<String, Any?>
            get() = hashMapOf(
                "status" to ApiConstant.Status.SUCCESS.value,
                "data" to hashMapOf(
        ...
        val getPendingOrders: HashMap<String, Any?>
            get() = hashMapOf(
                "status" to ApiConstant.Status.SUCCESS.value,
                "data" to listOf(
                    newDeliveryOrder1, newDeliveryOrder2, newDeliveryOrder1, newDeliveryOrder2, newDeliveryOrder1,
                    newDeliveryOrder2, newDeliveryOrder1, newDeliveryOrder2, newDeliveryOrder1, newDeliveryOrder2
                )
            )
        ...
        val getTransactions: HashMap<String, Any?>
            get() = hashMapOf(
                "status" to ApiConstant.Status.SUCCESS.value,
                "data" to listOf(transaction1, transaction2, transaction3, transaction4)
            )
