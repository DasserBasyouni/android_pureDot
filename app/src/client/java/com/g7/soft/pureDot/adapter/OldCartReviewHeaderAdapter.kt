...
class OldCartReviewHeaderAdapter(
    private val items: List<ProductModel>
) :
    ListAdapter<String, OldCartReviewHeaderAdapter.ViewHolder>(OldCartReviewHeaderDiffCallback()) {
    ...
    class ViewHolder private constructor(private val binding: ItemCartReviewHeaderBinding) :
        ...
        fun bind(
            ...
            binding.recyclerView.adapter =
                OldCartReviewInnerAdapter().also { it.submitList(brandItems) }
        }
...
class OldCartReviewHeaderDiffCallback : DiffUtil.ItemCallback<String>() {
